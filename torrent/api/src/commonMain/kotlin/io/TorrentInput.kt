...
fun TorrentInput(
    ...
    TorrentInput(
        RandomAccessFile(file, "r"), pieces, logicalStartOffset, onWait, bufferSize, size,
 ...
 */
// Player positions start at zero; piece offsets may start inside a multi-file torrent.
// Read-ahead must stop at unfinished pieces and the logical file boundary.
