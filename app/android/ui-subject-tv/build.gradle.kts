...
android {
    namespace = "me.him188.ani.tv.ui.subject"
...
dependencies {
    ...
    // 仅复用其详情状态层 (SubjectDetailsViewModel/SubjectDetailsState, D3); UI 自绘
    api(projects.app.shared.uiSubject) // public ViewModel factory and presentation types
