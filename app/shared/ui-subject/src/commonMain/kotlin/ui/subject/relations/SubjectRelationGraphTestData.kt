...
/**
 * 来自 Bangumi 真实系列的关系图, 由服务器算法计算得到.
 */
@TestOnly
object TestSubjectRelationGraphs {
    /** Re:Zero, 从第二季进入. 每一季下挂有番外和衍生 */
    ...
    /** 鬼灭之刃: 主线上有剧场版和特别篇等次要条目 */
    val Kimetsu = SubjectRelationGraph(
        subjectId = 328195,
        mainline = listOf(
            SubjectRelationGraphMainNode(
                subject(294137, "鬼滅の刃 兄妹の絆", "鬼灭之刃 兄妹的羁绊", PackedDate(2019, 3, 29), SubjectRelationGraphPlatform.MOVIE, 1, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
            ...
            SubjectRelationGraphMainNode(
                subject(349032, "鬼滅の刃 浅草編", "鬼灭之刃 浅草篇", PackedDate(2021, 9, 12), SubjectRelationGraphPlatform.TV, 1, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
                subject(349033, "鬼滅の刃 鼓屋敷編", "鬼灭之刃 鼓屋敷篇", PackedDate(2021, 9, 18), SubjectRelationGraphPlatform.TV, 1, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
                subject(317002, "鬼滅の刃 那田蜘蛛山編", "鬼灭之刃 那田蜘蛛山篇", PackedDate(2020, 10, 17), SubjectRelationGraphPlatform.TV, 1, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
                subject(322102, "鬼滅の刃 柱合会議・蝶屋敷編", "鬼灭之刃 柱合会议・蝶屋敷篇", PackedDate(2020, 12, 20), SubjectRelationGraphPlatform.TV, 1, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
            ...
            SubjectRelationGraphMainNode(
                subject(422759, "鬼滅の刃 遊郭編 特別編集版", "鬼灭之刃 游郭篇 特別编集版", PackedDate(2023, 4, 1), SubjectRelationGraphPlatform.TV, 2, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
            ...
            SubjectRelationGraphMainNode(
                subject(484412, "鬼滅の刃 刀鍛冶の里編 特別編集版", "鬼灭之刃 刀匠村篇 特別编集版", PackedDate(2024, 5, 4), SubjectRelationGraphPlatform.TV, 2, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
            ...
            SubjectRelationGraphMainNode(
                subject(569579, "鬼滅の刃 柱稽古編 特別編集版", "鬼灭之刃 柱训练篇 特別编集版", PackedDate(2025, 7, 16), SubjectRelationGraphPlatform.TV, 2, UnifiedCollectionType.NOT_COLLECTED),
                isMinor = true,
                branches = emptyList(),
            ),
            SubjectRelationGraphMainNode(
