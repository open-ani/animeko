...
object TestSubjectRelationGraphs {
    ...
    /** 鬼灭之刃: 剧场版在主线上, 总集篇和特别篇列在正片下. 第一部之前的 "兄妹的羁绊" 是剧场版形式的总集篇 */
        ...
        mainline = listOf(
            SubjectRelationGraphMainNode(
                ...
                branches = listOf(
                    ...
                    SubjectRelationGraphBranch(subject(350764, "鬼滅の刃 無限列車編", "鬼灭之刃 无限列车篇", PackedDate(2021, 10, 10), SubjectRelationGraphPlatform.TV, 7, UnifiedCollectionType.NOT_COLLECTED), SubjectRelation.SEQUEL),
                ),
            ),
            SubjectRelationGraphMainNode(
