...
class GetEpisodeCollectionTypeUseCaseImpl(
    ...
    override suspend fun invoke(episodeId: Int, allowNetwork: Boolean): UnifiedCollectionType? {
        return episodeCollectionRepository.getEpisodeCollectionType(episodeId, allowNetwork)
    }
}